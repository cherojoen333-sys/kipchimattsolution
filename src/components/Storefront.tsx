      ...
      >
        ...
        <div className="p-4 flex-1 flex flex-col">
          ...
          <div className="mt-auto">
            {isOutOfStock ? (
              <div className="text-center text-[10px] font-bold text-plum bg-plum-fade py-1 rounded-md mb-2 flex items-center justify-center gap-1.5 border border-plum/15">
